...
class UnaryStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Initiateconn = channel.unary_unary(
                '/unary.Unary/Initiateconn',
                request_serializer=unary__pb2.initMessage.SerializeToString,
                response_deserializer=unary__pb2.initMessageResponse.FromString,
                )
...
def add_UnaryServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Initiateconn': grpc.unary_unary_rpc_method_handler(
                    servicer.Initiateconn,
                    request_deserializer=unary__pb2.initMessage.FromString,
                    response_serializer=unary__pb2.initMessageResponse.SerializeToString,
            ),
    }
...
class Unary(object):
    ...
    def Initiateconn(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/unary.Unary/Initiateconn',
            unary__pb2.initMessage.SerializeToString,
            unary__pb2.initMessageResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
